	...
	<nav class="navbar top-navbar navbar-expand-md navbar-light">
		<div class="navbar-header">
			<a class="navbar-brand" href="index.html">
				...
				<span>
					<!-- dark Logo text -->
					<img src="<?= base_url() ?>assets/img/layout/logo.png" alt="homepage" class="dark-logo" width="100" />
					<!-- Light Logo text -->
					<img src="<?= base_url() ?>assets/img/layout/logo.png" class="light-logo" alt="homepage" />
				</span>
			</a>
		</div>
